...
mkdir -p nm-exp-active-netrics/usr/local/src/nm-exp-active-netrics/
...
cp /usr/local/src/nm-exp-active-netrics/bin/makecron.py nm-exp-active-netrics/usr/local/src/nm-exp-active-netrics/bin/
