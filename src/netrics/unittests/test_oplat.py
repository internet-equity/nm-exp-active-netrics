...
from netrics.builtin import netrics_test_oplat as netrics
from netrics.unittests.mock_measurements import Measurements


class TestOplat(unittest.TestCase):
    """Class for methods of oplat unit tests"""
    ...
    def test_oplat_success(self):
        ...
        try:
            with warnings.catch_warnings():
                ...
                output = netrics.test_oplat(self.key, self.measurement, args, results, False)
        ...
        #RESOLVE OPLAT EXEC FORMAT ERROR
